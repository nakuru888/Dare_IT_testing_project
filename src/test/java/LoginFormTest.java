...
public class LoginFormTest {
    ...
    public void loginPage_LoginWithInvalidCredentials_FailureWithCorrectErrorMessageDisplayed() {
        ...
        //then
        Assertions.assertThat(loginPage.getErrorMessageBannerText())
                .isIn(INCORRECT_CAPTCHA_ERROR_MESSAGE,
    ...
    private void validateLoginFormInputsErrorMessages(String expectedEmailInputErrorMessage, String expectedPasswordInputErrorMessage) {
        try {
            ...
            Assertions.assertThat(loginPage.getErrorMessageBannerText())
                    .isIn(INCORRECT_CAPTCHA_ERROR_MESSAGE, "Invalid Form Key. Please refresh the page.");
        }
    }
